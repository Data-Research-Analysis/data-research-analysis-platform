...
${platformUrl}`;
    ...
    public async sendLeadGeneratorEmail(params: {
        ...
        const html = await TemplateEngineService.getInstance().render('lead-generator-download.html', [
            { key: 'first_name', value: this.sanitizeForSubject(firstName) },
            { key: 'pdf_title', value: this.sanitizeForSubject(pdfTitle) },
            { key: 'download_url', value: downloadUrl },
            { key: 'support_email', value: supportEmail },
